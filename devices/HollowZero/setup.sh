...
#iptables -A INPUT -s 10.72.2.64/26 -m time --weekdays Mon,Tue,Wed,Thu,Fri -j ACCEPT
#iptables -A INPUT -s 10.72.1.0/24 -m time --weekdays Mon,Tue,Wed,Thu,Fri -j ACCEPT
